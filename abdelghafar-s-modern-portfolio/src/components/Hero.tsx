      ...
      <div className="section-container text-center space-y-8 animate-fade-in">
        ...
        <div className="flex gap-4 justify-center pt-4">
          <Button
            ...
            asChild
          >
            <a href="https://drive.google.com/file/d/1P2tUr1Nif28tfx6VNbv8jMWAdvEry_Uq/view?usp=drive_link" rel="noopener noreferrer" download="Abdelghafar_Nagy_Ahmed_CV.pdf">
